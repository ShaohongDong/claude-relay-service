  ...
  try {
    ...
    const dashboard = {
      overview: {
        ...
        activeApiKeys,
        // 总账户统计（所有平台）
        totalAccounts: claudeAccounts.length + claudeConsoleAccounts.length,
        normalAccounts: normalClaudeAccounts + normalClaudeConsoleAccounts,
        abnormalAccounts: abnormalClaudeAccounts + abnormalClaudeConsoleAccounts,
        pausedAccounts: pausedClaudeAccounts + pausedClaudeConsoleAccounts,
        rateLimitedAccounts: rateLimitedClaudeAccounts + rateLimitedClaudeConsoleAccounts,
        // 各平台详细统计
        accountsByPlatform: {
          claude: {
        ...
        // 保留旧字段以兼容
        activeAccounts: normalClaudeAccounts + normalClaudeConsoleAccounts,
