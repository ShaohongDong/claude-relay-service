  ...
  <Teleport to="body">
      ...
      >
        ...
        >
          <div class="mb-4 flex items-start gap-3">
            ...
            <div>
              <h5 class="mb-2 font-semibold text-blue-900 dark:text-blue-300">手动输入 Token</h5>
              <p
    ...
    <div v-if="isEdit" class="space-y-6">
      ...
      <div v-if="form.platform === 'claude-console'" class="space-y-4">
        ...
        <div>
          <label class="mb-3 block text-sm font-semibold text-gray-700">模型映射表 (可选)</label>
        ...
        <div>
          ...
          <div class="mb-3">
            ...
            <p class="mt-1 text-xs text-gray-500">启用后，当账号返回429错误时将暂停调度一段时间</p>
          </div>
